            ...
            <div class="panel-body">
                <?php if ($num > 0): ?>
                    <div class="table-responsive">
                        <table
                            class="dataTable table small table-striped-alt table-bordered table-hover table-condensed"
                            width="100%">
                            <thead>
                            <tr>
                            ...
                            <?php foreach ($cruises as $cruise): ?>
                                <?php if ($cruise->Cruise->availability && $cruise->Cruise->sellability): ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?php
                                            $cruise->Cruise->departure_date = str_replace('/', '-',
                                                $cruise->Cruise->departure_date);
                                        ...
                                        <td>
                                            <?php
                                            $cruise->Cruise->arrival_date = str_replace('/', '-',
                                                $cruise->Cruise->arrival_date);
                                        ...
                                        <td style="overflow: hidden;
                                          ...
                                          white-space: nowrap; max-width: 75px">
                                            ...
                                            <form role="form" id="cruise-select" data-type="Cruise" data-step="Select"
                                                  data-container="cruise_details" data-webservice="21">
                                                <input type="hidden" value="<?php echo $cruise->Cruise->code; ?>"
                                                       name="cruise-code">
                                                <input type="hidden"
                                                       value="<?php echo $cruise->CruisesCruiseLine->webservice_connection_type; ?>"
                                                       name="webservice">
                                                <button type="submit" class="btn btn-xs btn-info" data-control="api">
                                                    Select
                                                </button>
                                            </form>
